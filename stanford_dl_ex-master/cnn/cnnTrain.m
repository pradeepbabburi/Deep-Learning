...
% Load MNIST Train
addpath ../common/;
images = loadMNISTImages('../imagesMNIST/train-images-idx3-ubyte');
images = reshape(images,imageDim,imageDim,[]);
labels = loadMNISTLabels('../imagesMNIST/train-labels-idx1-ubyte');
...
testImages = loadMNISTImages('../imagesMNIST/t10k-images-idx3-ubyte');
testImages = reshape(testImages,imageDim,imageDim,[]);
testLabels = loadMNISTLabels('../imagesMNIST/t10k-labels-idx1-ubyte');
