function [train, test] = ex1_load_mnist(binary_digits)
  ...
  X=loadMNISTImages('../imagesMNIST/train-images-idx3-ubyte');
  y=loadMNISTLabels('../imagesMNIST/train-labels-idx1-ubyte')';
  ...
  y=loadMNISTLabels('../imagesMNIST/t10k-labels-idx1-ubyte')';
